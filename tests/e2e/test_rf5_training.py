...
def test_rf5_training(config_path, size, dataset_name, rf5_datasets, tmp_path):
    ...
    test_F1 = test_results.get("metrics/F1", 0.0)
    test_precision = test_results.get("metrics/precision", 0.0)
    test_recall = test_results.get("metrics/recall", 0.0)
    ...
    assert test_F1 >= 0.0, "F1 score should be non-negative"
